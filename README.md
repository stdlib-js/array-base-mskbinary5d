...
```javascript
mskbinary5d = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-mskbinary5d@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var mskbinary5d = require( 'path/to/vendor/umd/array-base-mskbinary5d/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/array-base-mskbinary5d@umd/browser.js"></script>
```
